            ...
            <div id="templatemo_content">
                <div id="templatemo_content_left"> 
                    <div class="templatemo_content_left_section">
                        <h1>Buscar</h1>
                        <form id="search" action="authors.php" method="GET">
                ...
                <div id="templatemo_content_right">
                    ...
                    <div class="templatemo_product_box">
                        <!--Open Header-->
                        <div class='buy_now_button'><a href='newAuthor.php'>Add Autor</a></div>
                        ...
                        <?php
                            ...
                            if(isset($deleteID)){
                                $sql = "DELETE FROM bookauthors WHERE AuthorID = '$deleteID'";
                                ...
                                echo '<div class="alerterror">
                                      Autor não foi deletado. Tente novamente!
                                    </div>';
                            }
                            }
                            ...
                            if(isset($search)) {
                                $sql = "SELECT AuthorID, nameF, nameL
                                        FROM bookauthors
                                        WHERE (nameF like '%$search%' OR nameL like '%$search%')
                        ...
                        <?php
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<div class='templatemo_product_box'>
                                     ...
                                     <table>
                                            <tr>
                                            <td><div class='Author'> <h2>$row[nameF] $row[nameL]</h2></div></td>
                                            <td>
                                            <div class='buy_now_button'><a href='author.php?authorID=$row[AuthorID]'>Editar</a></div>

                                            <td> <form action='authors.php' method='post'>
                                          <input name='deleteID' value='$row[AuthorID]' hidden />
